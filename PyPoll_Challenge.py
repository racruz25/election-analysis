...
with open(file_to_save, "w") as txt_file:
    ...
    for county in county_votes:
        ...
        county_results = (
            f"{county}: {county_percentage:.1f}% ({turnout:,})\n")
        ...
        if (turnout > largest_turnout) and (county_percentage > winning_percentage):
    ...
    # Added header for consistency with "County Votes:"
